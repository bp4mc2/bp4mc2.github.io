...
|Voorbeeld|Het schema dat het domein makelaardij label 'Makelaardij'.
|Min card.|1
...
|Voorbeeld|Het concept 'Aan- of verkoop van een huis' als meest generieke concept voor 'Koop', 'Opstellen bindende offerte', 'Overdragen Zakelijk recht', etc.
...
|Voorbeeld|Verkoop is onderdeel van een Koopp.
...
|Voorbeeld|De collectie die alle zakelijke rechten beschrijft.
|Eigenschappen en relaties|[http://bp4mc2.org/profiles/skos-ap-sc#Collection_provenance](http://bp4mc2.org/profiles/skos-ap-sc#Collection_provenance), [heeft lid](#Collection_hasMember), [label](#Collection_label)
...
|Voorbeeld|De collectie die alle zekelijke rechten beschrijftt heeft als label 'Zakelijke rechten'
|Min card.|1
