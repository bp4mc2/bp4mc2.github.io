...
|!form data!Eigenschap|versie (dataset versie)
|----------|------
...
|!form data!Eigenschap|versie-notities (dataset versie)
|----------|------
...
|!form data!Eigenschap|distributie (dataset versie)
|----------|------
...
|!form data!Eigenschap|herkomst (dataset versie)
|----------|------
|Eigenschap|[foaf:isPrimaryTopicOf](http://xmlns.com/foaf/0.1/isPrimaryTopicOf)
|Verwijst naar|[prov:Entity](http://www.w3.org/ns/prov#Entity)
...
|!form data!Eigenschap|versie (product)
|----------|------
|Eigenschap|[adms:version](http://www.w3.org/ns/adms#version)
|Datatype|[Tekst](http://www.w3.org/2001/XMLSchema#string)
...
|!form data!Eigenschap|versie notities (product)
|----------|------
|Eigenschap|[adms:versionNotes](http://www.w3.org/ns/adms#versionNotes)
|Datatype|[Tekst](http://www.w3.org/2001/XMLSchema#string)
...
|!form data!Eigenschap|distributie (product)
|----------|------
|Eigenschap|[dcat:distribution](http://www.w3.org/ns/dcat#distribution)
|Verwijst naar|[dcat:Distribution](http://www.w3.org/ns/dcat#Distribution)
...
|!form data!Eigenschap|herkomst (product)
|----------|------
|Eigenschap|[foaf:isPrimaryTopicOf](http://xmlns.com/foaf/0.1/isPrimaryTopicOf)
|Verwijst naar|[prov:Entity](http://www.w3.org/ns/prov#Entity)
...
|!form data!Eigenschap|beschrijving (catalogus)
|----------|------
|Eigenschap|[dcterms:description](http://purl.org/dc/terms/description)
|Datatype|[Tekst](http://www.w3.org/2001/XMLSchema#string)
...
|!form data!Eigenschap|naam (catalogus)
|----------|------
|Eigenschap|[dcterms:title](http://purl.org/dc/terms/title)
|Datatype|[Tekst](http://www.w3.org/2001/XMLSchema#string)
...
|!form data!Eigenschap|licentie (catalogus)
|----------|------
...
|!form data!Eigenschap|herkomst (catalogus)
|----------|------
|Eigenschap|[foaf:isPrimaryTopicOf](http://xmlns.com/foaf/0.1/isPrimaryTopicOf)
|Verwijst naar|[prov:Entity](http://www.w3.org/ns/prov#Entity)
...
|!form data!Eigenschap|rechten (catalogus)
|----------|------
...
|!form data!Eigenschap|beschrijving (distributie)
|----------|------
|Eigenschap|[dcterms:description](http://purl.org/dc/terms/description)
|Datatype|[Tekst](http://www.w3.org/2001/XMLSchema#string)
...
|!form data!Eigenschap|licentie (distributie)
|----------|------
|Eigenschap|[dcterms:license](http://purl.org/dc/terms/license)
...
|!form data!Eigenschap|herkomst (distributie)
|----------|------
|Eigenschap|[foaf:isPrimaryTopicOf](http://xmlns.com/foaf/0.1/isPrimaryTopicOf)
|Verwijst naar|[prov:Entity](http://www.w3.org/ns/prov#Entity)
...
|!form data!Eigenschap|rechten (distributie)
|----------|------
|Eigenschap|[dcterms:rights](http://purl.org/dc/terms/rights)
