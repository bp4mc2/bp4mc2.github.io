...
|Begrip|Komt voor in begrippenkaders|Kennisbron|
|------|----------------------------|----------|
|Ambtenaar|Boek 1|Art. 1 Aw|
|Ambtenaar|Boek 3 hfdst 4 en 5||
|Arrondissement|Boek 1||
|Arrondissement|Boek 3 hfdst 4 en 5||
|Berechting|Boek 1|Art. 1.1.7 lid 1 Sv|
|Berechting|Boek 4||
|Buitenvervolgstelling|Boek 2|Artikel 2.5.39 Sv Artikel 3.2.4 Sv|
|Buitenvervolgstelling|Boek 3 hfdst 4 en 5||
|Gerechtshof|Boek 1||
|Gerechtshof|Boek 3 hfdst 4 en 5||
|Gerechtshof|Boek 4||
|Getuige|Boek 1|Artikel 22.4 Sv  |
|Getuige|Boek 3 hfdst 4 en 5||
|Getuige|Boek 4||
|Hoger beroep|Boek 1||
|Hoger beroep|Boek 3 hfdst 4 en 5||
|Hoger beroep|Boek 4||
|Hulpofficier van Justitie|Boek 1|Art. 1.3.13 Sv art. 2 Pw 2012|
|Hulpofficier van Justitie|Boek 2|Artikel 1.3.13 Sv Artikel 2.1.13 Sv Artikel 2 Pw12 Artikel 2.1.12 Sv|
|Identiteitsbewijs|Boek 2|Artikel 1 WID|
|Identiteitsbewijs|Boek 3 hfdst 4 en 5||
|Officier van Justitie|Boek 1||
|Officier van Justitie|Boek 4||
|Opsporingsonderzoek|Boek 1||
|Opsporingsonderzoek|Boek 2|Artikel 132 lid a WvSv|
|Parket|Boek 1||
|Parket|Boek 3 hfdst 4 en 5||
|Procesinleiding|Boek 1|Art. 4.1.1 en 4.1.2 Sv|
|Procesinleiding|Boek 4||
|Rechtbank|Boek 3 hfdst 4 en 5||
|Rechtbank|Boek 4||
|Rechter|Boek 1|Uit een aantal (grond)wettelijke bepalingen inzake rechtspraak kan worden afgeleid dat rechtspraak moet geschieden door een onafhankelijke en onpartijdige derde, de rechter (m.n. de artikelen 116 en 117 Gw, alsook artikel 6 EVRM). De onafhankelijkheid en onpartijdigheid van de rechter worden aldus ook als essentieel kenmerk van rechtspraak beschouwd|
|Rechter|Boek 4||
|Rechtsgebied|Boek 2| Bijlage 9 RA Artikel 2.10.2 Sv|
|Rechtsgebied|Boek 3 hfdst 4 en 5||
|Slachtoffer|Boek 1|Artikel 1.2 Aanwijzing slachtoffers in het strafproces|
|Slachtoffer|Boek 4||
|Spreekrecht|Boek 1|Art. 1.5.8 Sv|
|Spreekrecht|Boek 4||
|Strafbaar feit|Boek 1||
|Strafbaar feit|Boek 3 hfdst 4 en 5||
|Strafbeschikking|Boek 1|art. 3.3.1 Sv|
|Strafbeschikking|Boek 3 hfdst 4 en 5||
|Verdachte|Boek 1|Art. 1.4.1 Sv|
|Verdachte|Boek 3 hfdst 4 en 5||
|Verdachte|Boek 4||
|Verklaring|Boek 1|Art. 4.2.37 Sv|
|Verklaring|Boek 3 hfdst 4 en 5||
|Vervolging|Boek 1||
|Vervolging|Boek 3 hfdst 4 en 5||
|Vervolging|Boek 4||
|
## Niet gevonden kennisbronnen

|Begrippenkader|Begrip|Kennisbron verwijzing|
|--------------|------|---------------------|
|Boek 1|Aanhouding| |
...
|Boek 1|Raadsman|MvT p. 120|
|Boek 1|Rechter-Commissaris|Art. 46 RO |
|Boek 1|Strafbeschikking|Art. 1.3.3|
...
|Boek 4|Eigen waarneming van de rechter|art. 4.3.9 Sv|
|Boek 4|Getuige|art. 1.6.1. - 1.6.4. Sv|
|Boek 4|Hoger beroep|https://www.rechtspraak.nl/Naar-de-rechter/Hoger-beroep|
|Boek 4|Openbaarheid van de berechting|art. 4.2.3 Sv|
|Boek 4|Procesinleiding|art 4.1.1 Sv|
|Boek 4|Raadkamer|art. 4.21.1 Sv|
|Boek 4|Rechten van de verdachte|art. 1.4.2 Sv|
|Boek 4|Rechten van het slachtoffer|Boek 1 Titel 5.2 Sv|
|Boek 4|Rechter-commissaris |art 1.2.25 Sv|
|Boek 4|Slachtoffer|art. 1.5.1. Sv|
|Boek 4|Spreekrecht|art. 1.5.8 Sv|
|Boek 4|Verdachte|art. 1.4.1. Sv|
|Boek 4|Verklaring van de verdachte|art. 4.3.9 Sv|
|Boek 4|Verklaring van een deskundige|art. 4.3.9 Sv|
|Boek 4|Verklaring van een getuige|art. 4.3.9 Sv|
|Boek 4|Voorzitter|art. 1.2.5. Sv|
|Boek 4|Wettig bewijsmiddel|art. 4.3.7 Sv|
|Boek 4|Wettig bewijsmiddel|art. 4.3.8 Sv|
|
## Begrippen met verwijsfouten

|Begrippenkader|Begrip|Ontbrekend begrip|Gevonden in|
|--------------|------|-----------------|-----------|
...
|Boek 2|Gebruiker van een communicatiedienst|rechtspersoon||
...
|Boek 3 hfdst 4 en 5|Beklag|vervolgen||
|Boek 3 hfdst 4 en 5|Getuige|strafzaak||
|Boek 3 hfdst 4 en 5|Geweld|rechtspersonen||
|Boek 3 hfdst 4 en 5|Hoger beroep|rechtzaak||
|Boek 3 hfdst 4 en 5|Klager|beklaagd||
|Boek 3 hfdst 4 en 5|Opsporing|strafbare feiten||
|Boek 3 hfdst 4 en 5|Opsporingsdienst|strafbare feiten||
|Boek 3 hfdst 4 en 5|Sepot|Officier van Justitie|Boek 4 Boek 1|
|Boek 4|Arrest|Gerechtelijke instantie||
|Boek 4|Beeld- en geluidopname als bewijsmiddel|wettigen bewijsmiddelen||
|Boek 4|Bewijscriterium "buiten redelijke twijfel"|Veroordeling||
|Boek 4|Deskundige|gerechtelijke deskundigen||
|Boek 4|Eigen waarneming van de rechter|Terechtzitting|Boek 1|
|Boek 4|Getuige|Bewijsvoering||
|Boek 4|Laatste woord|Terechtzitting|Boek 1|
|Boek 4|Officier van Justitie|Openbaar aanklager||
|Boek 4|Officier van Justitie|Openbaar Ministerie|Boek 1|
|Boek 4|Openbaarheid van de berechting|Rechtspraak||
...
|Boek 4|Verklaring van een deskundige|Terechtzitting|Boek 1|
|Boek 4|Verklaring van een getuige|Terechtzitting|Boek 1|
|Boek 4|Vonnis|Terechtzitting|Boek 1|
|Boek 4|Voorbereidend onderzoek|Terechtzitting|Boek 1|
|Boek 4|Voorzitter|Terechtzitting|Boek 1|
|
## Begrippen zonder definitie

|Begrippenkader|Begrip|
|--------------|------|
|Boek 1|Actoren in het strafproces|
|Boek 1|Daad van vervolging|
|Boek 1|Gerechterlijke instanties|
|Boek 1|Objectief|
|Boek 1|Politiebevoegdheden|
|Boek 1|Rechterlijke behandeling van de strafzaak|
|Boek 1|Rechtsmiddelen|
|Boek 1|Subjectief|
|Boek 1|Verdachtenrechten|
|Boek 1|Wet- en Regelgeving|
|Boek 4|Bewijs|
|Boek 4|Bewijsvoering|
|Boek 4|Delict|
|Boek 4|Feitelijke handelingen|
|Boek 4|Gerechtelijke deskundige|
|Boek 4|Gerechtelijke instantie|
|Boek 4|Natuurlijk persoon|
|Boek 4|Openbaar Ministerie|
|Boek 4|Openbaar aanklager|
|Boek 4|Rechterlijk college|
|Boek 4|Rechtspersoon|
|Boek 4|Rechtspraak|
|Boek 4|Schuld|
|Boek 4|Strafbaar feit|
|Boek 4|Strafrechten|
|Boek 4|Strafvordering|
|Boek 4|Terechtzitting|
|Boek 4|Uitspraak|
|Boek 4|Verdenking|
|Boek 4|Veroordeling|
|Boek 4|Voorzitter van de rechtbank|
|Boek 4|Wettelijk waarborg|
|
